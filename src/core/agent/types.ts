...
import type { CodexModel, EffortLevel, PermissionMode, StreamChunk } from '../types';
import type { SDKMessage, SDKUserMessage } from '../types/sdk';
...
export interface SessionState {
  ...
  sessionModel: CodexModel | null;
  pendingSessionModel: CodexModel | null;
