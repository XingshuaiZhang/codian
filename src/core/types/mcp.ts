 ...
 *
 * Types for configuring and managing MCP servers that extend Codex's capabilities.
 */
...
export interface CodianMcpServer {
  ...
  description?: string;
  source?: 'vault' | 'project' | 'global';
}

/** MCP configuration file format (Codex CLI compatible). */
