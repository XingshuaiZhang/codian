...
export interface Conversation {
  ...
  /** True if this conversation uses runtime-native storage (messages in ~/.codex/projects/). */
  isNative?: boolean;
 ...
 * Stored in vault/.codex/sessions/{id}.meta.json
...
export interface SessionMetadata {
   ...
   * Stored here because SDK session files don't preserve this Codian-specific data.
   */
  subagentData?: Record<string, SubagentInfo>;
  /** Assistant UUID for resumeSessionAt after rewind. */
  resumeSessionAt?: string;
...
export interface UsageInfo {
  ...
  percentage: number;
  isContextWindowAuthoritative?: boolean;
}
