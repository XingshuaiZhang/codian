...
export class StreamController {
    ...
    switch (chunk.type) {
      ...
      case 'context_window_update': {
        ...
        if (state.usage && chunk.contextWindow > 0) {
          ...
          state.usage = { ...state.usage, contextWindow, percentage, isContextWindowAuthoritative: true };
        }
        break;
      }
  ...
  private handleRegularToolUse(
    ...
    // Track Write to ~/.codex/plans/ for plan mode (used by approve-new-session)
