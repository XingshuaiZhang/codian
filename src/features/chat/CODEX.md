...
```
User Input → InputController → CodianService.query()
                                      ↓
...
```typescript
// CodianService created on first query, not on tab create
